...
public class World {
	...
	for (int x = 0; x < World.world.length; x++) {
	    for (int y = 0; y < World.world[x].length; y++) { // Èíèöèàëèçèðóåì
							      // ìèð
		World.world[x][y] = "";
    ...
    public void mapWorld() { // Ïðîñìîòð èãðîâîé êàðòû
	...
	System.out.println(" *******************************************");
	System.out.println(" **      ÊÐÀÒÊÈÅ ÎÁÎÇÍÀ×ÅÍÈß ÍÀ ÊÀÐÒÅ     **");
	System.out.println(" *******************************************");
	System.out.println(" **    Ç - ÇÀÁÎÐ     ***    Ñ - ÑÒÅÍÀ     **");
	System.out.println(" **    X - ÈÃÐÎÊ     ***    Ò - ÒÅËÅÏÎÐÒ  **");
	System.out.println(" **    Ä - ÄÂÅÐÜ     ***    Â - ÂÎÐÎÒÀ    **");
	System.out.println(" *******************************************");
